...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
      ...
      function _(a, e) {
        if (a) {
          if (typeof a == 'string') return O(a, e)
      ...
      var C = {
          ...
          object: function (e) {
            var t = this,
              n = []
            return (
              Object.entries(e.properties || {}).forEach(function (o) {
                var i,
                  u = A(o, 2),
                  d = u[0],
                  s = u[1]
                n.push(
                  ''
                    .concat(d)
                    .concat(
                      (i = e.required) !== null && i !== void 0 && i.includes(d)
                        ? ''
                        : '?',
                      ': '
                    )
          ...
          function: function (e) {
            var t = this,
              n = e.signature,
              o = 'oneOf' in n ? n.oneOf : [n]
            return o
              .map(function (i) {
                return ''
                  .concat(i.isAsync ? 'async ' : '', '(')
                  .concat(
                    i.arguments
                      .map(function (u) {
                        return ''.concat(u.key, ': ').concat(t.toString(u))
                      })
                      .join(', '),
                    ') => '
                  )
                  .concat(t.toString(i.returnType))
              })
              .join(' | ')
          },
          dom: function (e) {
        ...
        M = function (e) {
          ...
          return (
            ...
            React.createElement('code', null, o)
          )
        },
        W = function (e) {
          var t,
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'th',
                    null,
                    s.formatMessage({ id: 'api.component.name' })
                  ),
                  React.createElement(
                    'th',
                    null,
                  ...
                  React.createElement(
                    'th',
                    null,
                    s.formatMessage({ id: 'api.component.type' })
                  ),
                  React.createElement(
                    'th',
                    null,
                    s.formatMessage({ id: 'api.component.default' })
                  )
                )
              ),
              React.createElement(
    ...
    93359: function (L, w, y) {
      ...
      var p = function (_) {
          return React.createElement(
            'span',
            j({ className: 'dumi-default-badge' }, _)
          )
        },
        A = null
    },
    96057: function (L, w, y) {
      'use strict'
      y.d(w, {
        Z: function () {
          return a
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
          ...
          return (
            (0, p.useEffect)(function () {
              ...
              if (m) {
                var b = j()(function () {
                  r(m.scrollLeft > 0),
                    v(m.scrollLeft < m.scrollWidth - m.offsetWidth)
                }, 100)
                return (
                  b(),
    ...
    93096: function (L, w, y) {
      var I = 'Expected a function',
        ...
        O = /^0o[0-7]+$/i,
        S = parseInt,
        k = typeof y.g == 'object' && y.g && y.g.Object === Object && y.g,
        C = typeof self == 'object' && self && self.Object === Object && self,
        M = k || C || Function('return this')(),
        W = Object.prototype,
        B = W.toString,
        a = Math.max,
        e = Math.min,
      ...
      function n(r, c, l) {
        ...
        ;(c = s(c) || 0),
          i(l) &&
            ...
            ($ = 'trailing' in l ? !!l.trailing : $))
        function F(f) {
          var T = g,
            x = v
          return (g = v = void 0), (N = f), (b = r.apply(x, T)), b
        }
        function J(f) {
          return (N = f), (h = setTimeout(D, c)), V ? F(f) : b
        }
        function X(f) {
          var T = f - R,
            x = f - N,
        ...
        function K(f) {
          return (h = void 0), $ && g ? F(f) : ((g = v = void 0), b)
        }
        function G() {
          h !== void 0 && clearTimeout(h), (N = 0), (g = R = v = h = void 0)
        }
        function Z() {
        ...
        function U() {
          var f = t(),
            T = H(f)
          if (((g = arguments), (v = this), (R = f), T)) {
            if (h === void 0) return J(R)
            if (P) return (h = setTimeout(D, c)), F(R)
          }
          return h === void 0 && (h = setTimeout(D, c)), b
        }
        return (U.cancel = G), (U.flush = Z), U
      }
      function o(r, c, l) {
        var g = !0,
          v = !0
      ...
      function d(r) {
        return typeof r == 'symbol' || (u(r) && B.call(r) == p)
      }
      function s(r) {
        ...
        r = r.replace(A, '')
        var l = _.test(r)
        return l || O.test(r) ? S(r.slice(2), l ? 2 : 8) : E.test(r) ? j : +r
      }
      L.exports = o
    },
  },
